...
await mcp({jsonrpc:'2.0',id:1,method:'initialize',params:{protocolVersion:'2025-06-18',capabilities:{},clientInfo:{name:'ai-factory-telegram-native-worker',version:'1.2.0'}}});await mcp({jsonrpc:'2.0',method:'notifications/initialized'});let rpcId=2;async function toolRaw(name,args={}){return mcp({jsonrpc:'2.0',id:rpcId++,method:'tools/call',params:{name,arguments:args}});}
